...
public class DataManager {
    ...
    public static boolean sendSMS2(Context context, int simID, String toNum, String centerNum, String smsText, PendingIntent sentIntent, PendingIntent deliveryIntent) {
