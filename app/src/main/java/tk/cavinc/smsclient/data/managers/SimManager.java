...
import tk.cavinc.smsclient.BuildConfig;

//https://www.programcreek.com/java-api-examples/index.php?source_dir=DualSIM-Manager-master/src/pl/com/android/dualsim/SimManagement.java#
// https://github.com/LIFECorp/mediatek/blob/master/frameworks/base/telephony/java/com/mediatek/telephony/TelephonyManagerEx.java
...
public class SimManager {
    ...
    public static synchronized SimManager getInstance(Context context) {
        if (INSTANCE == null) {
    ...
    public boolean isSupported() {
        ...
        try {
            ...
            // https://docplayer.net/23356583-Mediatek-sdk-for-android-developer-s-guide.html
